...
public class Main {
    public static void main(String[] args) {
         ...
         final String testName2 = "Ivan";
         final String testLastName2 = "Ivanov";
         final byte testAge2 = 5;

         final String testName3 = "Ivan";
         final String testLastName3 = "Ivanov";
         final byte testAge3 = 5;

         final String testName4 = "Ivan";
         final String testLastName4 = "Ivanov";
         final byte testAge4 = 5;
